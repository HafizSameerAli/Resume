            ...
            <div class="row">
                <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                    <div class="card-body cc-experience-header">
                        ...
                        <div class="h5">Aziz Sons.</div>
                    </div>
                </div>
                <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                    <div class="card-body">
                        <div class="h5">Assistant IT</div>
                        <p>

                            •	Daily User related Complain. <br />
                            •	IT Related Equipment Purchasing. <br />
            ...
            <div class="container cc-education">
                    ...
                    <div class="row">
                        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body cc-education-header">
                                <p>2015 - 2019</p>
                                <div class="h5">DADABHOY INSTITUTE OF HIGHER EDUCATION </div>
                            </div>
                        </div>
                        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body">
                                <div class="h5">Bachelor's of Computer Science</div>
                ...
                <div class="card">
                    <div class="row">
                        ...
                        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                            <div class="card-body">
                                <div class="h5">Intermediate from Commerce Private</div>
                                <p class="category">Private Institute of Commerce</p>
                                <!----  <p>Euismod massa scelerisque suspendisse fermentum habitant vitae ullamcorper magna quam iaculis, tristique sapien taciti mollis interdum sagittis libero nunc inceptos tellus, hendrerit vel eleifend primis lectus quisque cubilia sed mauris. Lacinia porta vestibulum diam integer quisque eros pulvinar curae, curabitur feugiat arcu vivamus parturient aliquet laoreet at, eu etiam pretium molestie ultricies sollicitudin dui.</p> !-->
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="card-body">
                                                <form action="https://formspree.io/f/xbjpwqlj" method="POST"  enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <button class="btn btn-primary" name="chilkatExample" type="submit">Send</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
